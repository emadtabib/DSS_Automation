...
public class PLPSelectors {
	...
	public static final cselector GRrecommendedOption =new cselector("css,li.unbxd-as-popular-product.unbxd-as-popular-product-grid .unbxd-as-popular-product-info","css,.c-arrange.u-flexbox.c--align-middle.u-align-center a");

	public static final cselector BDrecommendedOption =new cselector("css,li.unbxd-as-popular-product.unbxd-as-popular-product-grid .unbxd-as-popular-product-info","css,li.unbxd-as-keysuggestion","css,.c-arrange.u-flexbox.c--align-middle.u-align-center a");
