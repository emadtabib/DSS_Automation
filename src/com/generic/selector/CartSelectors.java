...
public class CartSelectors{
	...
	//Welcome Modal close
	public static final cselector closeWelcomeModal=new cselector("css,.offer-control.close");
	...
	public static final cselector firstAddedItemsOption=new cselector("css,div.left-main-panel > div> div > div> div > div > div > div> div > div>div","css,.c-cart-product-item__product-attributes > div > div");
	...
	public static final cselector lastAddedItemsOptionInGR=new cselector("css,#shopping-cart-v2-root > div > div.main-panel > div.left-main-panel > div.items-container > div:nth-child(2) > div.order-item-display-wrapper");
	public static final cselector lastAddedItemsOptionInGRMob=new cselector("css,.u-border-light-bottom > div:nth-child(2)");
	...
	public static final cselector GHoptionsButton =new cselector("css,div.gwt-product-option-panel-control-inner.enabled > div.gwt-product-option-panel-widget-panel > div > div > div", "css,.m-product-options-no-padding > div > div > div:nth-child(1) > button");
